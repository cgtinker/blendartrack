from .models import PoseData, ScreenToWorldData, FaceMeshData, BlendShapeData, CameraProjectionData, PointCloudData, MeshGeometryData
...
def init_face_mesh_geo_model(json_data, title):
    ...
    print("import face mesh geometry model data successful")
    return model_data, True
